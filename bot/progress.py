...
async def print_barcode(word_name, data_to_encode, name, price, usd_price, barcode_name='barcode.png', page=1):
    try:
        ...
        await update_document('aaa.docx', new_file_path, name, price, usd_price, barcode_image_path)
        
        # Wait for the document processing to finish before printing
        await print_document(new_file_path, page)
        
        time.sleep(1)  # Add a small delay to ensure file is not in use
